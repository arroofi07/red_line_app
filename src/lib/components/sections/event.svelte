...
<section id="projects" class="projects-section relative overflow-hidden py-24">
	<!-- Grain overlay -->
	...
	<div class="section-inner container mx-auto px-4 md:px-6">
		...
		<div class="mb-16 flex flex-col items-center gap-4 text-center">
			...
			>
				Latest <span class="text-primary">Event</span>
			</h2>
		</div>
		<!-- Main grid -->
		<div class="main-grid">
