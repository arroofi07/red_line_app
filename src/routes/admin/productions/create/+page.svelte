<script lang="ts">
	...
	import { createProduction } from '$lib/firebase/productions';
...
<svelte:head>
	<title>Tambah Production — Admin Redline</title>
</svelte:head>
...
<div class="page">
	<div class="page-header">
		<div>
			...
			<h1 class="page-title">Tambah Production Baru</h1>
		</div>
	</div>
		...
		<div class="form-col-side">
			<div class="side-card">
				...
				<button type="submit" class="submit-btn" disabled={saving}>
					{saving ? '⏳ Menyimpan...' : 'Simpan Production'}
				</button>
